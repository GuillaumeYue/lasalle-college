...
import { USER_UPDATE_REQUEST, USER_UPDATE_SUCCESS, USER_UPDATE_FAIL, USER_UPDATE_RESET  } from '../constants/userConstants.js'
...
export const updateUser = (user) => async (dispatch, getState) => {
    try {
        ...
        const config = {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${userInfo.token}`, // 使用正确的 userInfo.token
            },
        };
